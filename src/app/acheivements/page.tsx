...
function Acheivements(){
    return(
        <div className="flex flex-col justify-center w-full h-full my-28" >
            <ol className="flex flex-col w-auto max-w-[90vw] ml-24 rounded-xl p-12  border-3 border-[var(--bg3)]" style={{backgroundImage:"linear-gradient(120deg,var(--bg2) 10%,var(--bg) 100%)"}}>
                ...
                <li>
                    <motion.div style={{overflow:"hidden"}} initial={{opacity:0,width:0}} animate={{opacity:1,width:"auto"}} transition={{duration:1, type:"tween", delay:0}}> 
                        <h1 className="text-start text-4xl lg:text-nowrap">
            ...
            <div className="flex flex-col w-auto max-w-[90vw] ml-24 mt-8 rounded-xl p-12  border-3 border-[var(--bg3)]" style={{backgroundImage:"linear-gradient(120deg,var(--bg2) 10%,var(--bg) 100%)"}}>
                <h1 className={`text-center w-full text-5xl mb-12 ${silkscreen.className}`}>Gallery</h1>
            ...
            <div className="flex flex-col w-auto max-w-[90vw] ml-24 mt-8 rounded-xl p-12  border-3 border-[var(--bg3)]" style={{backgroundImage:"linear-gradient(120deg,var(--bg2) 10%,var(--bg) 100%)"}}>
                <h1 className={`text-center w-full text-5xl mb-12 ${silkscreen.className}`}>Certifications</h1>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative w-full h-full">
